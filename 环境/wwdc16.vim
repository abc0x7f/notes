...
if !get(g:, 'wwdc16_use16', 0)
  ...
  if !has('gui_running') && get(g:, 'wwdc16_transp_bg', 0)
    ...
    hi Normal ctermfg=231 ctermbg=none guifg=#ffffff guibg=#292c36 guisp=NONE cterm=NONE gui=NONE
...
if !has('gui_running') && get(g:, 'wwdc16_transp_bg', 0)
  ...
  hi Normal ctermfg=15 ctermbg=none guifg=#ffffff guibg=#292c36 guisp=NONE cterm=NONE gui=NONE
